              ...
              {programs.length > 0 ? (
                <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
                  {programs.map((program, idx) => {
                    ...
                    const descText = program.subCourseId?.description || program.courseId?.description || program.description || "Designed for mid to senior professionals looking to upskill and advance their career trajectory.";
