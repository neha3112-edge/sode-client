            ...
            <div className="bg-white rounded-3xl p-6 sm:p-10 border border-slate-200/80 shadow-xs">
              <div className="flex flex-col md:flex-row gap-6 items-center">
                <div className="flex-1 space-y-4 w-full">
                  <Skeleton.Input active size="small" style={{ width: 120, height: 24, borderRadius: 12 }} />
                  <Skeleton active paragraph={{ rows: 2, width: ["90%", "60%"] }} title={false} />
                  <Skeleton active paragraph={{ rows: 3, width: ["100%", "95%", "80%"] }} title={false} />
                  <div className="flex gap-3 pt-2">
                    <Skeleton.Button active size="large" style={{ width: 140, height: 44, borderRadius: 12 }} />
                    <Skeleton.Button active size="large" style={{ width: 140, height: 44, borderRadius: 12 }} />
                  </div>
                </div>
                <div className="w-full md:w-80 h-56 bg-slate-200/80 rounded-2xl animate-pulse" />
              </div>
            </div>
