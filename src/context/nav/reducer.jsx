...
export function navReducer(state, action) {
    switch (action.type) {
        ...
        case actionTypes.OPEN_PANEL:
            return { ...state, isPanelClose: false };
        case actionTypes.CLOSE_PANEL:
            return { ...state, isPanelClose: true };
        case actionTypes.COLLAPSE_PANEL:
            return { ...state, isPanelClose: !state.isPanelClose };

        case actionTypes.OPEN_BOX:
            return { ...state, isBoxCollapsed: true };
        case actionTypes.CLOSE_BOX:
            return { ...state, isBoxCollapsed: false };
        case actionTypes.COLLAPSE_BOX:
            return { ...state, isBoxCollapsed: !state.isBoxCollapsed };

        case actionTypes.OPEN_READ_BOX:
            return { ...state, isReadBoxOpen: true, isAdvancedBoxOpen: false, isEditBoxOpen: false };
        case actionTypes.CLOSE_READ_BOX:
            return { ...state, isReadBoxOpen: false };

        case actionTypes.OPEN_ADVANCED_BOX:
            return { ...state, isAdvancedBoxOpen: true, isReadBoxOpen: false, isEditBoxOpen: false };
        case actionTypes.CLOSE_ADVANCED_BOX:
            return { ...state, isAdvancedBoxOpen: false };

        case actionTypes.OPEN_EDIT_BOX:
            return { ...state, isEditBoxOpen: true, isAdvancedBoxOpen: false, isReadBoxOpen: false };
