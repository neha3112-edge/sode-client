...
import { Button, Row, Col, Tag, Breadcrumb, Empty, Pagination } from "antd";
import {
  CheckCircleFilled,
  StarFilled,
  SwapOutlined,
      ...
      <div className="px-4 pb-4 flex justify-between items-center gap-2 mt-auto">
        ...
        <div className="flex items-center gap-2">
          <Button
            ...
            className={`font-semibold rounded-lg h-8 px-2.5 text-xs cursor-pointer ${
              inCompare
