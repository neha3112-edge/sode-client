          ...
          {testimonialsList.map((item, idx) => {
            ...
            return (
              <div key={idx} className="px-2.5 pb-10 pt-1">
                <div className="bg-white rounded-3xl p-6 sm:p-7 border border-slate-200/80 shadow-2xs hover:shadow-md transition-all duration-300 flex flex-col justify-between h-full min-h-102.5">
                  {/* Top: Stars & Quote */}
                  <div>
                    {/* 5-Star Rating */}
