...
import useLanguage from "@/components/locale/userLanguage";
import { dataForTable } from "@/components/locale/dataStructure";
import { useGetDynamicListQuery } from "@/redux/dynamic/action"; // ⚡ FIXED: RTK Query हुक को इम्पोर्ट किया
