          ...
          {admissionSteps.map((step, idx) => {
            ...
            return (
              ...
              >
                ...
                {/* Step Title */}
                <h3 className="text-[14px] sm:text-[15px] font-bold text-[#111827] mb-2 leading-snug m-0 text-center">
                  {step.title}
                </h3>

                {/* Step Description */}
                <p className="text-[12px] sm:text-[12.5px] text-[#4b5563] leading-[1.65] font-normal m-0 text-center">
                  {step.desc}
                </p>
              </div>
            );
