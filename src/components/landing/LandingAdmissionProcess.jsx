        ...
        <div className="grid grid-cols-1 sm:grid-cols-2 md:grid-cols-3 lg:grid-cols-6 gap-3.5 sm:gap-4">
          {admissionSteps.map((step, idx) => {
            ...
            return (
              <div
                key={num}
                className={`${cardBg} rounded-xl border-b-4 ${style.borderBottom} p-4 sm:p-4 pt-5 pb-5 text-center flex flex-col items-center justify-start h-full transition-transform hover:-translate-y-1 shadow-2xs hover:shadow-xs`}
              >
